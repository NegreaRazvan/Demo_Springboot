...
public class EnrollmentService {
    ...
    private final RabbitEnrollmentEventPublisher enrollmentEventPublisher;

    public EnrollmentService(EnrollmentRepository enrollmentRepository, EmployeeRepository employeeRepository, CourseRepository courseRepository, EnrollmentMapper enrollmentMapper, RabbitEnrollmentEventPublisher enrollmentEventPublisher) {
    ...
    public EnrollmentResponse createEnrollment(EnrollmentRequest request){
        ...
        enrollmentEventPublisher.enrollmentCreated(savedEnrollment);
